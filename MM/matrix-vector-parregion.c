...
*   maintained for the entire matrix.  Performed by using the OpenMP parallel 
*   region only (manually to distribute workload) 
*   The update of the shared global total is
